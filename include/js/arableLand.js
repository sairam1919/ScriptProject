...
var indiaPercentLand = {}, indiaHectPerPerson = {}, indiaHectares = {}, africaPercentLand = {}, continentHectares = {} ,country = {};
var title = [], continent = [];
...
rlMain.on('close', function() {
  fs.writeFile('../../Feed/continentHectares.json', JSON.stringify(values(continentHectares)));
  fs.writeFile('../../Feed/africaPercentLand.json', JSON.stringify(values(africaPercentLand)));
  fs.writeFile('../../Feed/indiaPercentLand.json', JSON.stringify(values(indiaPercentLand)));
  fs.writeFile('../../Feed/indiaHectPerPerson.json', JSON.stringify(values(indiaHectPerPerson)));
  fs.writeFile('../../Feed/indiaHectares.json', JSON.stringify(values(indiaHectares)));
});
}
